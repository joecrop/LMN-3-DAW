...
class InputListView : public juce::Component,
                      public app_view_models::ItemListState::Listener,
                      public app_services::MidiCommandManager::Listener {
  public:
    InputListView(tracktion::Edit &e, juce::AudioDeviceManager &dm,
                  app_services::MidiCommandManager &mcm);
    ~InputListView() override;
  ...
  private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(InputListView)
};
